 ...
 */
@WebServlet(name = "LabelMakerCZ", urlPatterns
        = {
            "/cz/LabelMaker"
        })
public class LabelMakerCZ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        udb.addUser("[CZ];" + IPDetector.getClientIpAddr(request));

        Labels labels = new Labels("czech");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<div class=\"header\">Label Maker&#8480;"
                    ...
                    + "<img src=\"/EnterpriseApps/images/czech_flag.png\" alt=\"Czech\" class=\"langimg\"/>"
                    + "</div>"
                    + "</div>");
            ...
            out.println("<form method=\"POST\" action=\"/EnterpriseApps/LabelMaker/PreviewPDF\" accept-charset=\"UTF-8\" name=\"FForm\" target=\"pdfFrame\">"
                    ...
                    + "<tr>"
                    + "<td>"
                    + "<div class=\"label\" title=\"Vyplňte název zboží\">"
                    + labels.getTitle()
                    + "</div>"
                    + "</td>"
                    + "<td>"
